...
//RooArgList writeFormula(RooWorkspace* w, RooRealVar* r, TString tag,int cat);
...
//	TString workdir = "/afs/cern.ch/user/w/wahung/work/CMSSW_8_0_26_patch1/src/HiggsMassConstraint_new/HiggsMassConstraint/test/170731_spline_newreso_neweff_prod_170623/rpdfWS_withCat/";
	RooWorkspace* wo, *ws;
	TFile* fm, *f;
...
//	RooRealSumPdf* ggH = new RooRealSumPdf(pdfname.Data(), pdfname.Data(), pdf_list, coeffs_list);
