#include "../src/ProcessNormalization.cc"
...
//******************* qqzz and Template **************************
    ...
    char* tmpl_input_dir = "/afs/cern.ch/user/w/wahung/work/public/CombineLimitDbkgkin/CMSSW_7_4_7/src/HiggsAnalysis/CombinedLimit/TemplateBuilder/run/test_temp";
    TFile *fqqzz = new TFile(Form("%s/qqzz_templates_noCut_Normalized.root",tmpl_input_dir),"read");
    ...
    RooDataHist qqzzdatahist("qqzz_datahist"+chan+Form("_%d_cat%d",cate_vbf,cat),"qqzz_datahist", hist_argset, th2f_qqzz);
    RooHistPdf qqzzhistpdf("qqzz_histpdf"+chan+Form("_%d_cat%d",cate_vbf,cat),"qqzz_histpdf", hist_argset, qqzzdatahist);
    ...
    RooDataHist qqzzdatahist_up("qqzz_datahist_up"+chan+Form("_%d_cat%d",cate_vbf,cat),"qqzz_datahist", hist_argset, th2f_qqzz_up);
    RooHistPdf qqzzhistpdf_up("qqzz_histpdf_up"+chan+Form("_%d_cat%d",cate_vbf,cat),"qqzz_histpdf", hist_argset, qqzzdatahist_up);
    ...
    RooDataHist qqzzdatahist_dn("qqzz_datahist_dn"+chan+Form("_%d_cat%d",cate_vbf,cat),"qqzz_datahist", hist_argset, th2f_qqzz_dn);
    RooHistPdf qqzzhistpdf_dn("qqzz_histpdf_dn"+chan+Form("_%d_cat%d",cate_vbf,cat),"qqzz_histpdf", hist_argset, qqzzdatahist_dn);
...
//********************* ZX and Template ***************************
			...
			TFile *f_zx = new TFile(Form("%s/ZX_templates_noCut_Normalized.root",tmpl_input_dir),"read");
...
//********************* data ******************************************
	...
	w.import(*zjetpdf_up,RecycleConflictNodes());
		...
		TFile *fwork ;
		if(highmass==0)
			fwork= new TFile("workspace_2d_bkg_onshell_with_dbkgkin_cat/hzz4l_"+chan+Form("%dS_cat%d_13TeV.input_func.root",cate_vbf,cat),"recreate");
		if(highmass==1)
...
void bkgWorkspace_with_Dbkgkin_withCat(TString chan, int vbfcate, int highmass,int cat){	 
