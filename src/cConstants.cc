...
namespace {
  cConstantSpline DbkgkinSpline2e2mu("$CMSSW_BASE/src/HiggsAnalysis/CombinedLimit/data/cconstants/SmoothKDConstant_m4l_Dbkgkin_2e2mu13TeV.root");
  cConstantSpline DbkgkinSpline4e("$CMSSW_BASE/src/HiggsAnalysis/CombinedLimit/data/cconstants/SmoothKDConstant_m4l_Dbkgkin_4e13TeV.root");
  cConstantSpline DbkgkinSpline4mu("$CMSSW_BASE/src/HiggsAnalysis/CombinedLimit/data/cconstants/SmoothKDConstant_m4l_Dbkgkin_4mu13TeV.root");
  cConstantSpline DVBF2jetsSpline("$CMSSW_BASE/src/HiggsAnalysis/CombinedLimit/data/cconstants/SmoothKDConstant_m4l_DjjVBF13TeV.root");
  cConstantSpline DVBF1jetSpline("$CMSSW_BASE/src/HiggsAnalysis/CombinedLimit/data/cconstants/SmoothKDConstant_m4l_DjVBF13TeV.root");
  cConstantSpline DZHhSpline("$CMSSW_BASE/src/HiggsAnalysis/CombinedLimit/data/cconstants/SmoothKDConstant_m4l_DjjZH13TeV.root");
  cConstantSpline DWHhSpline("$CMSSW_BASE/src/HiggsAnalysis/CombinedLimit/data/cconstants/SmoothKDConstant_m4l_DjjWH13TeV.root");
}
